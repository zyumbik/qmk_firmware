...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_split_3x5_2(
        LALT_T(KC_Q),   KC_W,           KC_E,           KC_R,   KC_T,            KC_Y,   KC_U,   KC_I,      KC_O,             RCMD_T(KC_P),
        LCMD_T(KC_A),   KC_S,           KC_D,           KC_F,   KC_G,            KC_H,   KC_J,   KC_K,      KC_L,             RALT_T(KC_SCLN),
        LSFT_T(KC_Z),   LCTL_T(KC_X),   LALT_T(KC_C),   KC_V,   KC_B,            KC_N,   KC_M,   KC_COMM,   RCTL_T(KC_DOT),   RSFT_T(KC_SLSH),
    ...
    [SYM] = LAYOUT_split_3x5_2(
        ...
        // (reset layer, see below)
        RCMD_T(KC_NO),   _______,        // left
        TO(NAV),         RCMD_T(KC_NO)   // right
        ),
    ...
    [NAV] = LAYOUT_split_3x5_2(
        ...
        KC_LSFT, KC_F1,   KC_F2,   KC_F3,   KC_F4,                       KC_RCMD,  KC_VOLD, KC_VOLU, KC_RCTL,  KC_RSFT,
    ...
    [GAME] = LAYOUT_split_3x5_2(
        KC_TAB,    KC_Q,       KC_W,       KC_E,       KC_1,         KC_NO,  KC_NO,   KC_UP,   KC_NO,      KC_NO,
        KC_LCMD,   KC_A,       KC_S,       KC_D,       KC_F,         KC_NO,  KC_LEFT, KC_DOWN, KC_RIGHT,   KC_NO,
        KC_LSFT,   KC_Z,       KC_X,       KC_C,       KC_0,         KC_NO,  KC_J,    KC_I,    KC_K,       KC_L,
        KC_LALT,   KC_SPC,     // left
        KC_SPC,    KC_RSFT     // right
        ),

    [EMPTY] = LAYOUT_split_3x5_2(
        QK_BOOT,    RGB_TOG,    RGB_HUI,    _______,    _______,         _______,    _______,    _______,    _______,    _______,
